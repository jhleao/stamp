...
```sh
python3 scripts/tutorial_video.py
```

The builder uses the verified `studio.png` product screenshot, macOS narration,
and ffmpeg. Keep the commands and vocabulary synchronized with the CLI.
