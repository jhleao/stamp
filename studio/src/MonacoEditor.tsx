...
function configureMonaco() {
  ...
  monaco.editor.defineTheme("stamp-light", {
    ...
    rules: [
      ...
      { token: "tag.component.stamp", foreground: "275ea8", fontStyle: "bold" },
      { token: "tag.html.stamp", foreground: "8a5a3b" },
      { token: "delimiter.tag.stamp", foreground: "9aa3ac" },
      { token: "attribute.name.stamp", foreground: "805b9b" },
      { token: "delimiter.equals.stamp", foreground: "9aa3ac" },
      { token: "delimiter.quote.stamp", foreground: "9aa3ac" },
      { token: "string.attribute.stamp", foreground: "3f7a59" },
      { token: "string.tailwind.stamp", foreground: "276f55" },
  ...
  monaco.editor.defineTheme("stamp-dark", {
    ...
    rules: [
      ...
      { token: "tag.component.stamp", foreground: "82aaff", fontStyle: "bold" },
      { token: "tag.html.stamp", foreground: "c78a68" },
      { token: "delimiter.tag.stamp", foreground: "67717b" },
      { token: "attribute.name.stamp", foreground: "c792ea" },
      { token: "delimiter.equals.stamp", foreground: "67717b" },
      { token: "delimiter.quote.stamp", foreground: "67717b" },
      { token: "string.attribute.stamp", foreground: "addb67" },
      { token: "string.tailwind.stamp", foreground: "9ccc65" },
